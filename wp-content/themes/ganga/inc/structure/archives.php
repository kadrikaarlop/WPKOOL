...
if ( ! function_exists( 'ganga_archive_title' ) ) {
	add_action( 'ganga_archive_title', 'ganga_archive_title' );
	/**
	 * Build the archive title
	 *
	 */
	function ganga_archive_title() { ?>
		<header class="page-header<?php if ( is_author() ) echo ' clearfix';?>">
			<?php
			/**
			 * ganga_before_archive_title hook.
			 *
			 */
			do_action( 'ganga_before_archive_title' );
			?>
			...
			<?php
			/**
			 * ganga_after_archive_title hook.
			 *
			 */
			do_action( 'ganga_after_archive_title' );
			...
			/**
			 * ganga_after_archive_description hook.
			 *
			 */
			do_action( 'ganga_after_archive_description' ); ?>
		</header><!-- .page-header -->
		<?php
	}
}

if ( ! function_exists( 'ganga_filter_the_archive_title' ) ) {
	add_filter( 'get_the_archive_title', 'ganga_filter_the_archive_title' );
	/**
	 ...
	 */
	function ganga_filter_the_archive_title( $title ) {
		if ( is_category() ) {
