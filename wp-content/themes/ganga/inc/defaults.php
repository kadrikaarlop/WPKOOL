...
if ( ! function_exists( 'ganga_get_defaults' ) ) {
	/**
	 * Set default options
	 *
	 */
	function ganga_get_defaults() {
		$ganga_defaults = array(
			'hide_title' => '',
			'hide_tagline' => true,
			'top_bar_width' => 'full',
		...
		return apply_filters( 'ganga_option_defaults', $ganga_defaults );
	}
}

if ( ! function_exists( 'ganga_get_color_defaults' ) ) {
	/**
	 * Set default options
	 */
	function ganga_get_color_defaults() {
		$ganga_color_defaults = array(
			'top_bar_background_color' => '#ff5544',
			'top_bar_text_color' => '#ffffff',
			'top_bar_link_color' => '#ffffff',
			'top_bar_link_color_hover' => '#dddddd',
			'header_background_color' => '#044170',
			'header_text_color' => '',
			'header_link_color' => '',
			'header_link_hover_color' => '',
			'site_title_color' => '#ffffff',
			'site_tagline_color' => '#ffffff',
			'navigation_background_color' => '#044170',
			...
			'subnavigation_text_color' => '#ff5544',
			...
			'fixed_side_content_background_color' => '#ff5544',
			...
			'content_title_color' => '',
			'blog_header_bg_color' => '#044170',
			'blog_header_title_color' => '#ff5544',
			'blog_header_text_color' => '#ffffff',
			'blog_header_button' => '#ffffff',
			'blog_header_button_bg' => '#ff5544',
			...
			'form_button_background_color' => '#044170',
			'form_button_background_color_hover' => '#ffffff',
			'form_button_text_color' => '#ffffff',
			'form_button_text_color_hover' => '#222222',
			'back_to_top_background_color' => 'rgba(4,65,112,0.7)',
			'back_to_top_background_color_hover' => '#044170',
			'back_to_top_text_color' => '#ffffff',
			'back_to_top_text_color_hover' => '#ffffff',
		);

		return apply_filters( 'ganga_color_option_defaults', $ganga_color_defaults );
	}
}
...
if ( ! function_exists( 'ganga_get_default_fonts' ) ) {
	 ...
	 */
	function ganga_get_default_fonts( $filter = true ) {
		$ganga_font_defaults = array(
			'font_body' => 'Lato',
			'font_body_category' => '',
		...
		if ( $filter ) {
			return apply_filters( 'ganga_font_option_defaults', $ganga_font_defaults );
		}

		return $ganga_font_defaults;
	}
}

if ( ! function_exists( 'ganga_spacing_get_defaults' ) ) {
	/**
	 ...
	 * @return array Option defaults.
	 */
	function ganga_spacing_get_defaults( $filter = true ) {
		$ganga_spacing_defaults = array(
			'top_bar_top' => '6',
			'top_bar_right' => '20',
			'top_bar_bottom' => '3',
			'top_bar_left' => '20',
		...
		if ( $filter ) {
			return apply_filters( 'ganga_spacing_option_defaults', $ganga_spacing_defaults );
		}

		return $ganga_spacing_defaults;
	}
}

if ( ! function_exists( 'ganga_get_default_color_palettes' ) ) {
	/**
	 * Set up our colors for the color picker palettes and filter them so you can change them.
	 *
	 */
	function ganga_get_default_color_palettes() {
		$palettes = array(
			'#ff5544',
			'#044170',
			'#222222',
		...
		return apply_filters( 'ganga_default_color_palettes', $palettes );
	}
}

if ( ! function_exists( 'ganga_typography_default_fonts' ) ) {
	/**
	 * Set the default system fonts.
	 *
	 */
	function ganga_typography_default_fonts() {
		$fonts = array(
			'inherit',
			'System Stack',
		...
		return apply_filters( 'ganga_typography_default_fonts', $fonts );
	}
}

define( 'GANGA_DEFAULT_FONTS' , '//fonts.googleapis.com/css?family=Lato:100,100italic,300,300italic,regular,italic,700,700italic,900,900italic' );
