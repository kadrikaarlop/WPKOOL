...
$navigation_active = ( 'nav-left-sidebar' == ganga_get_navigation_location() ) ? true : false;
...
?>
<div id="left-sidebar" itemtype="https://schema.org/WPSideBar" itemscope="itemscope" <?php ganga_left_sidebar_class(); ?>>
	<div class="inside-left-sidebar">
		<?php
		/**
		 * ganga_before_left_sidebar_content hook.
		 *
		 */
		do_action( 'ganga_before_left_sidebar_content' );
		...
		/**
		 * ganga_after_left_sidebar_content hook.
		 *
		 */
		do_action( 'ganga_after_left_sidebar_content' );
		?>
